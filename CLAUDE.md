...
Installed Claude Code skills (playwright-cli, selenium-automation, vitest, webapp-testing) live in `.agents/skills/` and `.claude/skills/` — these are managed by the skills system and should not be manually edited.
